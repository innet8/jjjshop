		...
		<view class="coupon-detail-top">
					...
					<view :class="'coupon-item coupon-item-' + detail.color.text">
						<view class="operation d-b-c w-b">
							...
							<view class="right-box d-c-c d-c">
								...
								<view v-if="detail.state.value > 0" class="f26 coupon-btn theme-btn" @click="receiveCoupon()">领取</view>
			...
			<view class="o-h pro_list" v-if="apply_range != 10">
				<view class="d-b-c f-w">
					<view class="pro_item" v-for="(item, index) in listData" :key="index" @click="gotoPage('/pages/product/detail/detail?product_id=' + item.product_id)">
						<view class="pro_item_image"><image :src="item.product_image || '/static/default.png'" mode="aspectFill"></image></view>
