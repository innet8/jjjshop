<template>
	<view class="index">
		...
		<view class="wallet-content">
			<view class="index-head" v-if="balance_open">
				<view class="card-bottom">
					<view class="width-150 font-30 pr flex-1" @click="gotoPay">
						<view>
							<image class="wallet_img" src="../../../static/icon/chongzhijiaofei.png" mode="aspectFill"></image>
						</view>
					...
					<view class="width-150 font-30 pr flex-1" @click="gotoList('rechange')">
						<view>
							<image class="wallet_img" src="../../../static/icon/chongzhijilu.png" mode="aspectFill"></image>
						</view>
			...
			<!-- <view class="index-body" style="margin-bottom: 20rpx;padding-bottom: 0;">
				<view class="body-head" style="border: none;">
