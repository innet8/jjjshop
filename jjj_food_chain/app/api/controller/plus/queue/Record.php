...
class Record extends Controller
{
    ...
    public function index($shop_supplier_id)
    {
        ...
        //我的取号
        $detail = (new QueueRecordModel)->myTake($this->postData(), $this->getUser());
        return $this->renderSuccess('', compact('tableList', 'tableNum', 'rule', 'detail'));
    }
    ...
    {
        $model = new QueueRecordModel;
        if ($model->cancel($this->postData(), $this->getUser())) {
