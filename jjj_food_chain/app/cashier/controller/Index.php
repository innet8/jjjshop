...
class Index extends Controller
{
     ...
     * @Apidoc\Param("shop_supplier_id", type="int", require=true, desc="商户id")
     * @Apidoc\Param("app_id", type="int", require=true, desc="门店id")
     * @Apidoc\Returned()
     */
    public function lang($shop_supplier_id, $app_id)
    {
