...
class Worker
{
    ...
    protected static function getEventLoopName()
    {
        ...
        if ($loop_name) {
            ...
            static::$eventLoopClass = \interface_exists('\React\EventLoop\LoopInterface') ? '\Workerman\Events\React\StreamSelectLoop' : '\workermans\Events\Select';
        }
        return static::$eventLoopClass;
    }
