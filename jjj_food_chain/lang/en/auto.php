...
return [
    ...
    "原商品总价" => "Total original product price",
    ...
    "绑定桌台失败" => "Failed to bind table",
    "绑定桌台成功" => "Binding table successfully",
    "添加商品成功" => "Product added successfully",
    "添加商品失败" => "Failed to add product",
    "会员卡不存在" => "Membership card does not exist",
    "使用会员成功" => "Use membership successfully",
    ...
    "商品会员折扣后单价" => "Product unit price after membership discount",
    ...
    "用户名必须为4-16位纯数字" => "Username must be 4-16 digits pure numbers",
    ...
    "商品会员折扣后单价 * 数量" => "Product unit price after membership discount * quantity",
    ...
    "请输入本班取出現金正确金额" => "Please enter the correct amount of cash withdrawn by this class",
...
",
    ...
    "请输入本班遗留备用金正确金额" => "Please enter the correct amount of reserve fund left over for this class",
