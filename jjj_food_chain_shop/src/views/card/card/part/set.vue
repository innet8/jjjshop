<template>
  ...
  <div class="basic-setting-content pl16 pr16">
    ...
    <el-form-item label="价格：" :rules="[{ required: true, message: '请填写价格' }]" prop="model.money">
      <el-input v-model="form.model.money" class="max-w460" type="number"></el-input>
      <div class="gray9">用户购买会员卡需要支付的金额，0为用户免费领取</div>
    </el-form-item>
<!--    <el-form-item label="库存：" :rules="[{ required: true, message: '请填写库存' }]" prop="model.stock">
    ...
    <el-form-item label="使用须知：" :rules="[{ required: true, message: '请填写使用须知' }]" prop="model.content">
