<template>
  ...
  <div>
    <div class="common-level-rail">
      <el-button size="small" type="primary" icon="Plus" @click="addArticle">添加资讯</el-button>
    </div>
    <div class="table-wrap">
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        <el-table-column prop="article_id" label="资讯ID" width="60"></el-table-column>
        ...
        <el-table-column prop="virtual_views" label="虚拟阅读量" width="100"></el-table-column>
        <el-table-column prop="actual_views" label="实际阅读量" width="100"></el-table-column>
        <el-table-column prop="article_sort" label="资讯排序" width="100"></el-table-column>
