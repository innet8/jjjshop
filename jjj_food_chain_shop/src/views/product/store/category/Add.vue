<template>
    <el-dialog :title="$t('添加普通分类')" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
        ...
        <el-form size="small" :model="form" label-position="top" :rules="formRules" ref="form">
            ...
            <el-form-item v-if="parent == 0" :label="$t('上级分类')" prop="parent_id" :rules="[{ required: true, message: $t('请选择上级分类') }]">
...
export default {
    ...
    methods: {
        ...
        addUser() {
            ...
            params.parent_id == '' ? params.parent_id = 0 : params.parent_id = params.parent_id;
