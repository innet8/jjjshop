    ...
    <div class="product-list">
        ...
        <div class="common-level-rail">
            <el-button size="small" type="primary" icon="Plus" v-auth="'/product/expand/unit/add'" @click="addClick">
                {{ $t('添加单位') }}</el-button>
            <el-button size="small" v-auth="'/product/expand/unit/delete'"
        ...
        <div class="product-content">
            <div class="table-wrap">
                <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading"
                    ...
                    <el-table-column prop="unit_name_text" :label="$t('单位名称')" width="400px"></el-table-column>
                    ...
                    <el-table-column fixed="right" :label="$t('操作')" width="120">
                        <template #default="scope">
                            <el-button @click="editClick(scope.row)" type="primary" link size="small"
                                v-auth="'/product/expand/unit/edit'">{{ $t('编辑') }}
                            </el-button>
                            <el-button @click="deleteClick(scope.row.unit_id)" type="primary" link size="small"
                                v-auth="'/product/expand/unit/delete'">{{ $t('删除') }}</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
