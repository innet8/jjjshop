  ...
  -->
    <div class="product-list">
        ...
        <div class="common-level-rail">
            <el-button size="small" type="primary" icon="Plus" v-auth="'/product/expand/label/add'" @click="addClick">
                {{ $t('添加标签') }}</el-button>
            <el-button size="small" v-auth="'/product/expand/label/delete'" @click="deleteBatch">{{ $t('批量删除')
            }}</el-button>
        </div>
        <!--内容-->
        <div class="product-content">
            <div class="table-wrap">
                <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading"
                    ...
                    <el-table-column prop="label_name_text" :label="$t('标签名称')" width="400px"></el-table-column>
