  ...
  <div class="diy-phone-container">
    ...
    <div class="wrapper">
      <div class="diy-phone-item" v-for="(item, index) in diyData.items" :key="item.id">
        ...
        <!--秒杀-->
        <template v-else-if="item.type == 'imageNav'">
          <imageNav :item="item" :index="index" :selectedIndex="form.selectedIndex"></imageNav>
        </template>
        <!--预告-->
        ...
        <template v-else-if="item.type == 'group'">
          <Groupindex :item="item" :index="index" :selectedIndex="form.selectedIndex"></Groupindex>
        </template>
        <!--砍价-->
