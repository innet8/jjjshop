<template>
  ...
  <div class="product-add">
    ...
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <el-form-item label="商品分类" v-if="user_type==0">
        <el-radio-group v-model="form.supplier.category_set" disabled>
      ...
      getData() {
        ...
        SupplierApi.toEditSupplier({
          ...
          .then(res => {
            ...
            if (res.data.model.user) {
              self.user_info.avatarUrl = res.data.model.user.avatarUrl;
              self.user_info.nickName = res.data.model.user.nickName;
            }
          })
          .catch(error => {
